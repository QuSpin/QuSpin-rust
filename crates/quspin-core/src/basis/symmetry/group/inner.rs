/// Inner types for all symmetry group variants.
///
/// Spin (LHSS = 2 and LHSS > 2 with spin-inversion):
/// - [`HardcoreGrpElement`] / [`HardcoreSymmetryGrp<B>`] — XOR bit-flip ops (LHSS = 2).
/// - [`DitSpinGrpInner<B, LHSS>`] — compile-time-LHSS spin-inversion hot-path (LHSS 3–5).
/// - [`DitSpinGrpDyn<B>`] — runtime-LHSS spin-inversion fallback (LHSS ≥ 6).
...
///
/// Dit (LHSS > 2 with value-permutation):
/// - [`DitValueGrpInner<B, LHSS>`] — compile-time-LHSS value-perm hot-path (LHSS 3–5).
/// - [`DitValueGrpDyn<B>`] — runtime-LHSS value-perm fallback (LHSS ≥ 6).
