// Extension trait adding basis-dependent dispatch methods to
// `BondOperatorInner`. Will move to `quspin-matrix` in PR 5.
pub use quspin_operator::BondOperatorInner;
...
impl super::super::OperatorDispatch for BondOperatorInner {
